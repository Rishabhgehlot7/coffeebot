...
const TryItem3 = (props) => {
    ...
    const handleOrder = () => {
        ...
        if (index !== -1) {
            ...
            setCarts([...carts, { title: data[2].item, price: data[2].price, qty: 1 }])
        }
    }
