...
const TryItem4 = (props) => {
    ...
    const handleOrder = () => {
        ...
        if (index !== -1) {
            ...
            setCarts([...carts, { title: data[3].item, price: data[3].price, qty: 1 }])
        }
    }
